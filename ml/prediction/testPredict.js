...
const cityBase = {
  distance_km: 8, travel_time_min: 25, wait_time_min: 6, traffic_ratio: 1.4,
  avg_speed_kmh: 19, weather_code: 0, rain_mm: 0, visibility_m: 6000,
  wind_speed: 5, feels_like_temp: 25, demand_ratio: 3.5, zone_driver_count: 8,
  hour: 8, day: 1, is_weekend: 0, is_public_holiday: 0, is_ramadan: 0,
};

const rain = { ...cityBase, weather_code: 4, rain_mm: 12, demand_ratio: 2.0 };

const intercityBase = {
  distance_km: 375, travel_time_min: 300, traffic_ratio: 1.1, avg_speed_kmh: 75,
  weather_code: 0, rain_mm: 0, visibility_m: 8000, wind_speed: 6, feels_like_temp: 28,
  dest_weather_code: 1, dest_rain_mm: 0, demand_ratio: 2.5, zone_driver_count: 10,
  booking_lead_time_hours: 24, toll_cost: 1000, dead_return_factor: 1.3,
  seats_booked: 2, seat_capacity: 4, hour: 9, day: 5, month: 5,
  is_weekend: 1, is_public_holiday: 0, is_ramadan: 0, cancellation_risk: 0.1,
};
